...
img=io.imread('/Users/xyyang/Desktop/img_2623.jpg')
...
img1=io.imread('/Users/xyyang/Desktop/img_2623.jpg')
image1=color.rgb2gray(img1)
img2=io.imread('/Users/xyyang/Desktop/img_2450.jpg')
image2=color.rgb2gray(img2)
img3=io.imread('/Users/xyyang/Desktop/img_3624.jpg')
image3=color.rgb2gray(img3)

refs = {
    'burger': local_binary_pattern(brick, n_points, radius, METHOD),
    'chicken': local_binary_pattern(grass, n_points, radius, METHOD),
    'donuts': local_binary_pattern(wall, n_points, radius, METHOD)
}

# classify rotated textures
print('Rotated images matched against references using LBP:')
print('original: burger, rotated: 30deg, match result: ',
      match(refs, rotate(brick, angle=30, resize=False)))
print('original: chicken, rotated: 70deg, match result: ',
      match(refs, rotate(brick, angle=70, resize=False)))
print('original: donuts, rotated: 145deg, match result: ',
...
ax1.imshow(brick)
ax1.axis('off')
hist(ax4, refs['burger'])
ax4.set_ylabel('Percentage')

ax2.imshow(grass)
ax2.axis('off')
hist(ax5, refs['chicken'])
ax5.set_xlabel('Uniform LBP values')

ax3.imshow(wall)
ax3.axis('off')
hist(ax6, refs['donuts'])
